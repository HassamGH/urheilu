...
export function DateBadge({ dateKey }: { dateKey: string }) {
  if (dateKey === 'TBD') {
    return (
      <div className="sm:w-14 shrink-0 flex items-baseline sm:flex-col sm:items-center gap-1.5 sm:gap-0 sm:pt-2 pb-2 sm:pb-0 border-b sm:border-b-0 border-brand-border">
